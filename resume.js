...
app.post('/upload-file', upload.single('file'), async (req, res) => {
  try {
    ...
    If the content does not appear to be a resume, please indicate this in the output. Ensure the analysis is comprehensive, actionable, and tailored to the specific job role provided.        
    `;
